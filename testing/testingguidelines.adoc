...
It is important to follow Sitka's testing guidelines to ensure testing is consistent and
...
[CAUTION]
=========
Screenshots should always be taken using an Evergreen community server.  In rare circumstances
